...
"""appsync.py:
    ...
    This module handles all AppSync operations.  It also invokes LangMesh basic
    Kendra RAG and advanced Kendra Agent with streaming option.  Callback
    handlers are used to process the asynchronous responses from the RAG and Agent.
    The callback handlers, in return, invoke GraphQL mutation to send the LLM
